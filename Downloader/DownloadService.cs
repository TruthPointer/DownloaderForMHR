...
public class DownloadService : AbstractDownloadService
{
    ...
    public DownloadService(int taskId, DownloadConfiguration options, ILoggerFactory loggerFactory = null) : base(taskId, options)
    {
    ...
    /// </summary>
    public DownloadService(int taskId, ILoggerFactory loggerFactory = null) : this(taskId, null, loggerFactory) { }
    ...
    private async Task SendDownloadCompletionSignal(DownloadStatus state, Exception error = null)
    {
        ...
        OnDownloadFileCompleted(new AsyncDownloadCompletedEventArgs(TaskId, error, isCancelled, Package));
    }
    ...
    {
        ChunkDownloader chunkDownloader = new ChunkDownloader(TaskId, chunk, Options, Package.Storage, Logger);
    ...
    public void ResetProxy(WebProxy webProxy)
    {
        Options.RequestConfiguration.Proxy = webProxy;
    }
