...
public abstract class AbstractDownloadService : IDownloadService, IDisposable, IAsyncDisposable
{
    ...
    /// </summary>
    public event EventHandler<AsyncDownloadCompletedEventArgs> DownloadFileCompleted;
    ...
    protected AbstractDownloadService(int taskId, DownloadConfiguration options)
    {
        TaskId = taskId;
    ...
    protected void OnDownloadFileCompleted(AsyncDownloadCompletedEventArgs e)
    {
